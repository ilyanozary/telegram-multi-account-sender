...
alter_table(cs, f"ALTER TABLE {utl.analyze} ADD batch int(11) NOT NULL DEFAULT 1 AFTER created_at")
...
alter_table(cs, f"ALTER TABLE {utl.files} ADD batch int(11) NOT NULL DEFAULT 1 AFTER uniq_id")
alter_table(cs, f"ALTER TABLE {utl.files} ADD msg_index tinyint(1) NOT NULL DEFAULT 1 AFTER batch")
